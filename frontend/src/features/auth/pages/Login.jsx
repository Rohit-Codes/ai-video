...
const Login = () => {
  ...
  const { userLogin, loading, user } = useAuthContext();
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-6 selection:bg-purple-500/30">
      ...
      {/* Back to Home or Logo */}
      <div className="absolute top-8 left-8 flex items-center gap-2 cursor-pointer z-20 hover:opacity-80 transition-opacity">
